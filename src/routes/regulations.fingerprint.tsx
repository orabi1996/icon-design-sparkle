...
export const Route = createFileRoute("/regulations/fingerprint")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "إدارة خصومات البصمة والتأخير وقيم الجزاءات المرتبطة بها مع الإضافة والتعديل والحذف." },
      { property: "og:title", content: "خصومات البصمة | نظام الموارد البشرية" },
      { property: "og:description", content: "إدارة خصومات البصمة والتأخير وقيم الجزاءات المرتبطة بها مع الإضافة والتعديل والحذف." },
...
function Fingerprint() {
  return (
    <div className="mt-4">
      ...
      <PageBanner icon="fingerprint" title="خصومات البصمة" subtitle="إضافة وتعديل وحذف البنود وحفظها مباشرة في قاعدة البيانات" />
      <CrudTable
        ...
        fields={[
          ...
          { key: "value_type", label: "نوع القيمة", type: "select", options: ["مبلغ ثابت", "نسبة من الأساسي", "يوم عمل", "ساعة عمل"] },
