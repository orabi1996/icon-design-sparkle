  ...
  head: () => ({
    meta: [
      { title: "لائحة الإستحقاقات | اللوائح المالية" },
      {
        name: "description",
        content:
          "إضافة وتعديل وحذف إستحقاقات الموظفين: بدل السكن والنقل والبدلات الأخرى وطريقة الاحتساب.",
      },
  ...
  return (
    <div className="mt-4">
      ...
      <PageBanner
        ...
        subtitle="إضافة وتعديل البدلات والاستحقاقات المالية"
      />
      <CrudTable
        table="entitlements"
        title="الإستحقاقات"
        ...
        fields={[
          { key: "name", label: "الإستحقاق", required: true },
          {
            ...
            type: "select",
            options: ["مبلغ ثابت", "نسبة من الأساسي", "ساعة عمل", "يوم عمل"],
          },
