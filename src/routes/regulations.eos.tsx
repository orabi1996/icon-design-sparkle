...
export const Route = createFileRoute("/regulations/eos")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "تهيئة قواعد احتساب مكافأة نهاية الخدمة ونسبها وعدد الأيام مع الإضافة والتعديل والحذف." },
      { property: "og:title", content: "لائحة نهاية الخدمة | نظام الموارد البشرية" },
      { property: "og:description", content: "تهيئة قواعد احتساب مكافأة نهاية الخدمة ونسبها وعدد الأيام مع الإضافة والتعديل والحذف." },
...
function Eos() {
  return (
    <div className="mt-4">
      ...
      <PageBanner icon="logout" title="لائحة نهاية الخدمة" subtitle="إضافة وتعديل وحذف البنود وحفظها مباشرة في قاعدة البيانات" />
      <CrudTable
        ...
        fields={[
          ...
          { key: "value_type", label: "نوع القيمة", type: "select", options: ["نسبة من الأساسي", "مبلغ ثابت", "يوم عمل"] },
