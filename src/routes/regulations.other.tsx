...
export const Route = createFileRoute("/regulations/other")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "إدارة الجزاءات ومراحل التأشيرات والمصاريف الحكومية وبقية اللوائح مع الإضافة والتعديل والحذف." },
      { property: "og:title", content: "لوائح أخرى | نظام الموارد البشرية" },
      { property: "og:description", content: "إدارة الجزاءات ومراحل التأشيرات والمصاريف الحكومية وبقية اللوائح مع الإضافة والتعديل والحذف." },
...
function Other() {
  return (
    <div className="mt-4">
      ...
      <PageBanner icon="rule_folder" title="لوائح أخرى" subtitle="إضافة وتعديل وحذف البنود وحفظها مباشرة في قاعدة البيانات" />
      <CrudTable
        ...
        fields={[
          ...
          { key: "value_type", label: "نوع القيمة", type: "select", options: ["مبلغ ثابت", "نسبة من الأساسي", "يوم عمل", "مراحل"] },
