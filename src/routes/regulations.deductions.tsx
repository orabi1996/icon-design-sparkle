  ...
  head: () => ({
    meta: [
      { title: "لائحة الإستقطاعات | اللوائح المالية" },
      {
        name: "description",
        content:
          "إضافة وتعديل وحذف إستقطاعات الموظفين: التأمينات الاجتماعية وخصومات الغياب والتأخير وأقساط السلف.",
      },
      { property: "og:title", content: "لائحة الإستقطاعات | اللوائح المالية" },
      {
        property: "og:description",
        content: "إدارة الإستقطاعات ونسب احتسابها وحفظها في قاعدة البيانات.",
      },
  ...
  return (
    <div className="mt-4">
      ...
      <PageBanner
        ...
        subtitle="إضافة وتعديل الخصومات ونسب احتسابها"
      />
      <CrudTable
        table="deductions"
        title="الإستقطاعات"
